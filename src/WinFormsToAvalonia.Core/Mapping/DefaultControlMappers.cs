...
public static class DefaultControlMappers
{
    ...
    [
        ...
        // The print family still has no framework support at all - measured against Avalonia's
        // reference assemblies there is not one Print* type - but it does have a page: a
        // PrintPage handler is drawing code, and once that translated, a document could be
        // rendered, previewed, laid out and exported. What is missing is the printer, not the page.
