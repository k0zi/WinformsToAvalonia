    ...
    internal async Task SaveSupplierAsync()
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync("Supplier name is required.","Validation",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Warning);
                return;
            }
    ...
    internal async Task DeleteSupplierAsync()
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync($"Could not delete supplier: {ex.Message}","Delete Failed",                WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Error);
            }
        }
    ...
    internal async void EmailLinkLabel_LinkClicked(object? sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync("No email address on file.","Send Email",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Information);
                return;
            }
    
            await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync($"Would open mail client for: {emailTextBox.Text}","Send Email",            WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Information);
        }
