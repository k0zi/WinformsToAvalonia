...
public partial class SettingsFormViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject
{
    ...
    internal void chooseColorButton_Click(object? sender, EventArgs e)
        {
            ...
            if (colorDialog.ShowDialog(this) == WarehouseAvaloniaApp.Common.DialogResult.OK)
            {
    ...
    internal void browseFolderButton_Click(object? sender, EventArgs e)
        {
            if (folderBrowserDialog.ShowDialog(this) == WarehouseAvaloniaApp.Common.DialogResult.OK)
            {
    ...
    internal async Task SaveGeneralAsync()
        {
            ...
            await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync("Settings saved.","Settings",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Information);
        }

    internal async Task SaveAdvancedAsync()
        {
            await PersistSettingsAsync();
            await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync("Advanced settings saved.","Settings",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Information);
        }
