    ...
    internal void AddNew()
        {
            ...
            if (form.ShowDialog(this) == WarehouseAvaloniaApp.Common.DialogResult.OK)
            {
                _ = ReloadAsync();
            }
        }
    ...
    internal async void quickAddDuplicate_Click(object? sender, EventArgs e)
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync("Select a product first.","Quick Add",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Information);
                return;
            }
