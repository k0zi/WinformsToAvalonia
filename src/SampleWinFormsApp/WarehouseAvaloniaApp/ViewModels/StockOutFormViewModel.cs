    ...
    internal async Task PostIssueAsync()
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync($"Could not post issue: {ex.Message}","Post Failed",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Error);
            }
            finally
            {
