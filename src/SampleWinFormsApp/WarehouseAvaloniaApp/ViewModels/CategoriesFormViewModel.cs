    ...
    internal async Task SaveCategoryAsync()
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync("Category name is required.","Validation",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Warning);
                return;
            }
    ...
    internal async Task DeleteCategoryAsync()
        {
            ...
            {
                await WarehouseAvaloniaApp.Common.Dialogs.ShowAsync($"Could not delete category — it may still have subcategories or products referencing it.\n\n{ex.Message}",                "Delete Failed",WarehouseAvaloniaApp.Common.MessageBoxButtons.OK,WarehouseAvaloniaApp.Common.MessageBoxIcon.Error);
            }
        }
