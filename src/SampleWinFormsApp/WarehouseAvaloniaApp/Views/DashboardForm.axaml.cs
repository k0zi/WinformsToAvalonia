...
public partial class DashboardForm : Window
{
    ...
    {
        InitializeComponent();
        DataContext = new WarehouseAvaloniaApp.ViewModels.DashboardFormViewModel();
    }

    private WarehouseAvaloniaApp.ViewModels.DashboardFormViewModel ViewModel => (WarehouseAvaloniaApp.ViewModels.DashboardFormViewModel)DataContext!;
