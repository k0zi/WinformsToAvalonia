...
public partial class PurchaseOrderDetailForm : DetailFormBase<PurchaseOrder>
{
    ...
    public PurchaseOrderDetailForm(PurchaseOrder? order = null) : base(order)
    {
        InitializeComponent();
        Text = IsNew ? "New Purchase Order — WarehouseApp" : $"Purchase Order — {order!.OrderNumber}";
    }
    ...
    private void AddLineRow(string productName, int quantity, decimal unitPrice, PurchaseOrderLine? existingLine = null, NewLine? newLine = null)
    {
