...
partial class StockInForm
{
    ...
    private DateTimePicker receiptDatePicker = null!;
    ...
    private void InitializeComponent()
    {
        ...
        this.dateLabel.Location = new System.Drawing.Point(12, 50);
        this.dateLabel.AutoSize = true;
        this.receiptDatePicker = new System.Windows.Forms.DateTimePicker();
        this.receiptDatePicker.Location = new System.Drawing.Point(100, 46);
        this.receiptDatePicker.Width = 180;
        this.quantityLabel = new System.Windows.Forms.Label();
        this.quantityLabel.Text = "Quantity:";
        this.quantityLabel.Location = new System.Drawing.Point(300, 50);
        this.quantityLabel.AutoSize = true;
        this.quantityStepper = new WarehouseApp.Controls.NumericStepperControl();
        this.quantityStepper.Location = new System.Drawing.Point(370, 44);
        ...
        this.addLineButton.Location = new System.Drawing.Point(520, 44);
        ...
        this.entryPanel.Controls.Add(this.receiptDatePicker);
        ...
        this.postButton.Text = "Post Receipt";
        ...
        this.postButton.Click += async (_, _) => await this.PostReceiptAsync();
        ...
        this.Text = "Stock In — Goods Receipt — WarehouseApp";
