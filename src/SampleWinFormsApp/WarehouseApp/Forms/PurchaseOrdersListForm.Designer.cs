...
partial class PurchaseOrdersListForm
{
    ...
    {
        this.Text = "Purchase Orders — WarehouseApp";
        ...
        this.Grid.Columns.AddRange(this.orderNumberColumn, this.supplierColumn, this.orderDateColumn, this.statusColumn);
