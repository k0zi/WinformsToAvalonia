...
- **AutocompleteSearchBox "productSearchBox" was converted separately**
  - Location: `/home/k0zi/Develop/Sources/GitHub/WinformsToAvalonia/src/SampleWinFormsApp/WarehouseApp/Forms/SalesOrderDetailForm.Designer.cs`
  - Description: Views/AutocompleteSearchBox.axaml and its ViewModel were generated from this control's own Designer.cs. These properties set on this instance were not simple public auto-properties on AutocompleteSearchBox (or not found at all) and were not carried over: Location, Width, DisplayMember. Wire them up manually if needed.
...
- **NumericStepperControl "quantityStepper" was converted separately**
  ...
  - Description: Views/NumericStepperControl.axaml and its ViewModel were generated from this control's own Designer.cs. These properties set on this instance were not simple public auto-properties on NumericStepperControl (or not found at all) and were not carried over: Location, Minimum, Maximum, Value. Wire them up manually if needed.
