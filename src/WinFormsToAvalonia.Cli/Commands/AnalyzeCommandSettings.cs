...
public sealed class AnalyzeCommandSettings : CommandSettings
{
    ...
    [Description("Path to the WinForms project (.csproj) or solution (.sln/.slnx) to analyze.")]
    ...
    public override ValidationResult Validate() => SourceValidation.ValidateSourceProjectOrSolution(Source);
}
